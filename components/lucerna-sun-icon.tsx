...
interface LucernaSunIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number
  glowing?: boolean
}

export function LucernaSunIcon({ size = 24, glowing = false, className = "", ...props }: LucernaSunIconProps) {
  return (
